...
const thumbs = new Splide('#thumbs-slider', {
    ...
    arrows: false,
    breakpoints: {
        640: {fixedWidth: 100, fixedHeight: 70}
    }
});
...
const MIN_GAP = 500,
    ...
    maxLimit = parseInt(maxRange.max);

const updateProgress = e => {
    let minVal = +minRange.value, maxVal = +maxRange.value;
...
const allowOnlyNumbers = input => {
    ...
    input.addEventListener("blur", () => input.value === "" && (input.value = 0));
};
